...
import { UntypedFormBuilder, FormControl, Validators, FormGroup, UntypedFormControl, UntypedFormGroup } from '@angular/forms';
...
export class ProfileComponent implements OnInit {
  ...
  constructor(
    ...
    // definir el profileForm amb totes les propietats anteriors
